...
public class MenuManager : MonoBehaviour
{
    ...
    public void NewGame()
    {
        ...
        StartCoroutine(RC.SceneChanger.MovePlayerToScene(3, player, new Vector3(0, -2.49f, 0)));
    ...
    public void LoadGame()
    {
        ...
        StartCoroutine(RC.SceneChanger.MovePlayerToScene(data.levelId, player, new Vector3(data.position[0], data.position[1], data.position[2])));
    }
    public void Options()
    {
